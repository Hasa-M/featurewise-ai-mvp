...
> Historical record only. Featurewise no longer produces a canonical
> GeneratedSpec. Findings are relational, individually addressable analysis
> output under ADR-0030.
